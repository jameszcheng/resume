...
\section{Projects}
    \resumeSubHeadingListStart
      ...
      % \resumeItemListEnd
      \resumeProjectHeading
  {\textbf{LLM Data Curation \& Constraint-Following Benchmark (CTG)} $|$ \emph{Python, uv, Together API}}{\textit{Jan. 2026 -- Present}}
  \resumeItemListStart
    \resumeItem{Built an LLM evaluation pipeline for \textbf{101 prompts} (32 local / 37 global / 32 hybrid) with deterministic verifiers and structured ablations to measure constraint-following reliability and pretraining-data quality.}
    \resumeItem{Implemented ID-based schema validation plus automated generation/scoring workflows, improving reproducibility and reducing prompt/response mismatch and reasoning-leakage noise in evaluations.}
  \resumeItemListEnd
